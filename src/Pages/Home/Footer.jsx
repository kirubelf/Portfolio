  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://web.facebook.com/kirubel.fiseha"
            ...
            <li>
              <a
                href="https://www.instagram.com/kirubel_fiseha/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/kirubel-fiseha-7205aa127/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Kirubel</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
